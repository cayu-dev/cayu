...
- [`ADVANCED_RUNTIME_EXAMPLES.md`](ADVANCED_RUNTIME_EXAMPLES.md) — asynchronous
  session forks, caching, compaction, counterfactual approval, repository
  tournaments, and taint isolation with explicit deterministic and live evidence
  boundaries.
