...
RECALL_BASELINE_CORPUS_SCHEMA_VERSION = "cayu.recall_baseline_corpus.v1"
RECALL_BASELINE_RESULT_SCHEMA_VERSION = "cayu.recall_baseline_result.v1"
...
class RecallBaselineCorpus(BaseModel):
    ...
    schema_version: Literal["cayu.recall_baseline_corpus.v1"]
    corpus_revision: str
...
class RecallBaselineResult(BaseModel):
    ...
    schema_version: Literal["cayu.recall_baseline_result.v1"]
    corpus_revision: str
...
async def run_recall_baseline(
    ...
    *,
    ...
    required_configuration = {
        ...
        "fusion_configuration_version": "public-recall-baseline-v1",
