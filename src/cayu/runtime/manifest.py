...
class AgentManifest(_ManifestModel):
    ...
    targeted_tool_mode: (
        Literal[
            "call_tool",
            "openai_additional_tools",
            "openai_additional_tools_or_call_tool",
        ]
        | None
    ) = None
    tool_policy: str
...
def _describe_agent(
    ...
    *,
    ...
    return AgentManifest(
        ...
        targeted_tool_mode=(
            None
            if registration.targeted_tool_mode is None
            else registration.targeted_tool_mode.value
        ),
        ...
        runtime_hooks=tuple(_type_name(item.hook) for item in registration.runtime_hooks),
