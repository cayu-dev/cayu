"""Agent snapshot contracts, capture, and materialization.
...
from cayu.snapshots._exports import EXPORTS as _EXPORTS
from cayu.snapshots._exports import PUBLIC_NAMES as _PUBLIC_NAMES
