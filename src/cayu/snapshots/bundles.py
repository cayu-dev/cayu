...
if TYPE_CHECKING:
    from cayu.snapshots.containers import AgentBundleContainerReceipt
...
async def _release_container_export_protection_after_publication(
    *,
    ...
    if not isinstance(destination, Path):
        from cayu.snapshots.containers import _reset_transactional_stream
...
class AgentBundleCoordinator:
    ...
    async def _export_container_locked(
        ...
        *,
        ...
        from cayu.snapshots.containers import _read_container
    ...
    async def import_container(
        ...
        *,
        ...
        from cayu.snapshots.containers import unpack_agent_bundle_container
