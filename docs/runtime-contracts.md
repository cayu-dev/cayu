...
terminal evidence. Missing, malformed, failed, or uncertain settlement evidence
keeps the workspace owner fenced until an operator verifies quiescence and
explicitly reopens execution. Cancellation received during the drain is carried
until the already-dispatched work reaches a definite outcome and is then
republished without admitting new work. Commands issued by the exact sync owner
