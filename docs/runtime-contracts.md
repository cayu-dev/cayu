...
round, or immutable publication receipt pins the affected recovery material
and makes the relevant maintenance operation return zero for that session.
