...
`PendingToolApproval.from_event(event)`, then use the returned `approval_id` and
tool-call data to construct the resolution or recovery request. The parser
