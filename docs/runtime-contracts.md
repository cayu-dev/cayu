...
`BudgetLimit` entries. Calendar windows are enforcement windows in this runtime
contract; notify-only budget actions require a separate event/hook policy.
